...
#
# A snippet is a piece of HTML to be included in a website. They are plain text
...
# you need to specify is defined in SnippetPath::JVMProperty. This allows system
...
# in a Hash of placeholders and dynamic values when instantiating a new snippet.
#
...
# == Snippet content
#
# Returning the snippet content is done by calling the +to_s+ method. This will replace
