# = Snippet
#
# Insane content management.
#
# A snippet (also known as "Schnipsel") is a piece of HTML to be included in a website.
# Snippets are plain text files stored on the file system.
#
# == Snippet path
#
# You need to specify the path to the snippet directory. This can be done by setting
# the +SnippetPathProperty+ as a JVM property or by using the +snippet_path+ method:
#
